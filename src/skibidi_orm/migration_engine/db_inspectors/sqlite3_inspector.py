...
class SQLite3Inspector(BaseDbInspector):
    ...
    def foreign_keys_from_pragma_entries(
        ...
        return_value: set[ForeignKeyConstraint] = set()
        ...
        for table_name, pragma_entry_list in table_entry_mapping.items():
            for id in set(entry.id for entry in pragma_entry_list):
                ...
                corresponding_constraint = ForeignKeyConstraint(
                    table_name,
                    referenced_table,
                    {
    ...
    def get_foreign_key_constraints(self) -> set[ForeignKeyConstraint]:
    ...
    def get_table_columns(self, table_name: str) -> list[SQLite3Adapter.Column]:
        ...
        return [
            SQLite3Adapter.Column(
                ...
                column_constraints=[
                    cast(ColumnSpecificConstraint, constraint)
                    for constraint in [
